...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('/') }}/images/parkoye_favicon.png">
    <link rel="icon" type="image/png" href="{{ asset('/') }}/images/parkoye_favicon.png">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta property="og:image" content="{{ asset('/') }}/images/parkoye_log.png">
    <title>{{ env('APP_NAME','Restaurant ParkOye') }}</title>
...
<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('/') }}/images/parkoye_favicon.png">
<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('/') }}/images/parkoye_favicon.png">
