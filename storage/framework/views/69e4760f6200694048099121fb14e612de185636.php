...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'ParkOye | Restaurant')); ?></title>

        <!-- Favicon -->
        <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('/')); ?>/images/parkoye_favicon.png">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/qrmenu/resources/views/layouts/app.blade.php ENDPATH**/ ?>