...
<?php $__env->startSection('content'); ?>
    ...
    <section class="section-profile-cover section-shaped grayscale-05  d-lg-block d-lx-block" style="height: 260px">
        <!-- Circles background -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title white" <?php if ($restorant->description || $openingTime && $closingTime) {
                        ...
                        <h1 class="display-3 text-white" data-toggle="modal"
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                                    <div class="strip">
                                        <?php if(!empty($item->image)): ?>
                                            <figure>
                                                <a onClick="setCurrentItem(<?php echo e($item->id); ?>)"
                                                   href="javascript:void(0)"><img
                                                        src="<?php echo e(asset('/')); ?><?php echo e($item->logom); ?>" loading="lazy"
                                                        data-src="<?php echo e(asset('/')); ?>/<?php echo e(config('global.restorant_details_image')); ?>"
