...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo e(asset('/')); ?>/images/parkoye_favicon.png">
    <link rel="icon" type="image/png" href="<?php echo e(asset('/')); ?>/images/parkoye_favicon.png">
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
    <meta property="og:image" content="<?php echo e(asset('/')); ?>/images/parkoye_log.png">
    <title><?php echo e(env('APP_NAME','Restaurant ParkOye')); ?></title>
...
<link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('/')); ?>/images/parkoye_favicon.png">
<link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('/')); ?>/images/parkoye_favicon.png">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/qrmenu/resources/views/layouts/front.blade.php ENDPATH**/ ?>